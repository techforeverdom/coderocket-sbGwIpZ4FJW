    ...
    <div className="space-y-6">
      <Card className="p-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-500 text-center">
            Your donation helps the {campaign.team} reach their championship goals.
          </p>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          {[
            { name: "Lincoln Alumni Association", amount: 500, time: "1 hour ago" },
            { name: "Johnson Family", amount: 100, time: "3 hours ago" },
            { name: "Anonymous", amount: 75, time: "5 hours ago" },
            { name: "Local Sports Boosters", amount: 250, time: "1 day ago" },
          ].map((supporter, index) => (
